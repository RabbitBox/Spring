...
@WebServlet(name = "conf", urlPatterns = "/confirmationInfo")
public class ConfirmationInfo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Order tmp = orderService.placeOrder(newOrder.getPizzaType(), newOrder.getPizzaSize(), clientName, clientAddress);
        ...
        webContext.setVariable("orderId", tmp.getOrderId());
